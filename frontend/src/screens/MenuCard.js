                    ...
                    <CardFooter>
                        {location.pathname === '/cart' ? (<>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'end' }}>
                                <div className='btns' >
                                    <Button variant='solid' colorScheme='red' pl='5' onClick={() => a.handleQuant(props._id, -1)} >
                                        -
                                    </Button>
                                    <Button variant='outline' colorScheme='green' pl='5' value="cnt">
                                        {props.quantity}
                                    </Button>
                                    <Button variant='solid' colorScheme='messenger' pl='5' onClick={() => a.handleQuant(props._id, +1)}>
                                        +
                                    </Button>
                                </div>
